...
class _LawyerCard extends StatelessWidget {
            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    labelText: AppStrings.filterBySpecialty,
                    contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  ),
                  items: [
                    const DropdownMenuItem(value: null, child: Text('All Specialties')),
                    ...['Family Law', 'Corporate Law', 'Criminal Law', 'Land Law', 'Labour Law']
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    labelText: AppStrings.filterByLocation,
                    contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  ),
                  items: [
  ...
  Widget _buildResultsHeader(int count) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      child: Text(
        '$count lawyer${count == 1 ? '' : 's'} available',
        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
          color: AppColors.textSecondary,
          fontWeight: FontWeight.w500,
        ),
